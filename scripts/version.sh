  ...
  # PRE="true"
  # BRANCH="development"
  # GITHUB_ACCESS_TOKEN="token REDACTED_ROTATED_2026"
  ...
  # API_RESPONSE_STATUS=$(curl --data "$API_JSON" --header 'Accept: application/vnd.github.v3+json' --header 'Authorization: token REDACTED_ROTATED_2026'  -s -i https://api.github.com/repos/$REPO_OWNER/$REPO_NAME/releases)
